...
We want to show a converse. We start with a simple case, when $m=n=1$.
...
so that $x+\epsilon$ is a root of $P$ modulo $\epsilon^2$. Using smoothness in the following diagram:
 \begin{center}
      \begin{tikzcd}
      R/\epsilon^2 & R[X]/P\ar[l,swap,"X\mapsto x+\epsilon"]\ar[ld,dotted]\\
      R\ar[u] &
      \end{tikzcd}
    \end{center} 
 ...
 implying that:
 \[ P''(x) \epsilon^2 = 0\]
 for any $\epsilon$ such that $\epsilon^3=0$, which is a contradiction by sqc.
\end{proof}
