...
\begin{proof}
  ...
  So one of the $f_i$ is regular by \cref{regular-non-zero-polynomial}.
  ...
  Since one of the $f_i$ is regular -- and in particular nilregular,
  this means that all of the $g_j$ are nilpotent and therefore $V=\emptyset$.
  This shows $U$ is dense.
\end{proof}

\begin{definition}
  A type is called \notion{reducible}, if there are two disjoint, non-empty open subsets.
\end{definition}
