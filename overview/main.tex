...
as it was used by Lawvere, when he described a program to develope mathematics inside of certain categories \cite{lawvere-categorical-dynamics}.
...
The derivative at $0:R$ of a function $f : R \to R$ may then be defined as $\pi_2(d(f_{\vert \D_1}))$, which is the start of a convenient way to develope calculus.
