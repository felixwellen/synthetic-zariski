...
The Kock-Lawvere axiom above is incompatible with the law of excluded middle (LEM) and therefore also with the axiom of choice (AC). Indeed they imply all maps from $R$ to $R$ are differentiable, which contradicts LEM. 
...
This is not true for spaces. For example, the topological space $\R$ with the euclidean topology is not the coproduct of the topological subspaces $\{0\}$ and $\R/\{0\}$.
