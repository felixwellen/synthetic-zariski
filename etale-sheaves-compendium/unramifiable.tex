...
\begin{proof}
  ...
  We first show \(\neg\neg\Std(P,Q)\to D_{P,Q}\).
  By being open, \(D_{P,Q}\) is double negation stable, so we can assume \(x:\Std(P,Q)=\{y:R\mid P(y)=0 \wedge Q(y)\neq 0\}\) and show \(D_{P,Q}\). We can also assume \(P=(X-e_1)\cdots (X-e_n)\) and up to double-negation we get \(x=e_i\). By the universal property of \(\Adu\), there is a map \(\Adu_{R,P}\to R\), mapping \(x_i\) to \(e_i\).
