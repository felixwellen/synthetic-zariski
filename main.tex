...
\begin{proposition}
  There is an isomorphism of partial orders
  \[ \text{f.g.-ideal} \xrightarrow{{\sim}} \Omega_{cl} \]
  between the partial oder of finitely generated ideals of $R$
  and the partial order of closed propositions.
\end{proposition}

\begin{proof}
  If $I = (x_1, \dots, x_n)$
  then the proposition $I = (0)$ is indeed a closed proposition,
