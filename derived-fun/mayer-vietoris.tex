...
\begin{proof}
  ...
  \begin{center}
    \begin{tikzcd}
      \prod\varphi_U^*\psi_U^*\mathcal F & \prod\psi_U^*\mathcal F\arrow[l] \\
      \prod\psi_V^*\mathcal F\arrow[u] & \prod\mathcal F\arrow[u]\arrow[l]
    \end{tikzcd}
  \end{center}
  ...
  \begin{center}
    \begin{tikzcd}
      1\arrow[d] & \Omega \prod\varphi_U^*\psi_U^* B^n\mathcal F\arrow[l]\arrow[d] \\
      (\prod\psi_V^*B^n\mathcal F)\times(\prod\psi_U^*B^n\mathcal F)\arrow[d]  & \prod B^n\mathcal F\arrow[l]\arrow[d] \\
      (\prod\varphi_U^*\psi_U^* B^n\mathcal F) \times (\prod\varphi_U^*\psi_U^* B^n\mathcal F) \arrow[d, "-"] & \prod\varphi_U^*\psi_U^* B^n\mathcal F\arrow[l]\arrow[d] \\
      \prod\varphi_U^*\psi_U^* B^n\mathcal F  & 1\arrow[l] 
    \end{tikzcd}
