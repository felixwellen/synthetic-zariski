...
\begin{definition}%
  ...
  \item \notion{Projective $n$-space} is the projectivization of $\A^{n+1}$,
    $\bP^n \colonequiv \bP(\A^{n+1})$.
  \end{enumerate}
\end{definition}
...
\begin{proposition}%
  For any line $\mathcal L : \A^{2}\to \Prop$, there merely is a degree one polynomial $P\in R[X_0,X_1]$ such that
  for all $x:\A^{2}$, $\mathcal L(x)$ is equivalent to $P(x)=0$.
\end{proposition}
\begin{proof}
