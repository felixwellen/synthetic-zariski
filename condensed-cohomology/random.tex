...
%\item (iii) implies (ii). We have that (iii) implies for $C:S\to 2$ that $\forall(x:S).\ C(x)$ is decidable. We conclude using that closed are countable intersection of decidable.
