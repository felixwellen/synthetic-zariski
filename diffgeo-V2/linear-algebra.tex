...
\begin{lemma}
Let $M$ be a finitely copresented module, then $T_0(M) = M$.
\end{lemma}
...
but by \cref{An-dimension-n} this is a map from $R^m$ to $R^n$, we omit the verification that $dP_0 = P$. TODO (neh)
\end{proof}
