...
this is generally different from having that existential quantifications over closed propositions is closed.
...
\begin{remark}
  ...
  \item If \(Y\) is \(\bP^n\), there is a closed subset \(V\subseteq \bP^n\) such that
...
We will now continue to prove generalities about compact types.
