...
\begin{theorem}%
  ...
  If the map $\coprod_i U_i\to X$ has cohomologically trivial fibers
  and for all $k:\N$ we have $H^1(U_{i_0\dots i_k},\mathcal F)=0$,
...
\begin{corollary}%
  ...
  Let $X$ have an cover $\{U\}$ with the same properties as in the theorem with respect to all $\mathcal F_1,\dots,\mathcal F_n$.
