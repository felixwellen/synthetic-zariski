...
\begin{definition}
  ...
  \item A cover $\{U\}=U_1,\dots,U_n$ is called \notion{acyclic} for $\mathcal F$
    ...
    \]
  \item A cover $\{U\}=U_1,\dots,U_n$ is called \notion{\v{C}ech-trivializing} for $\mathcal F$
...
\begin{theorem}%
  ...
  If $\{U\}$ is \v{C}ech-trivializing for $\mathcal F$, $\mathcal G$ and $\mathcal H$
...
\begin{proof}
  ...
  \[
    ...
    \rlap{.}
  \]
  The cover is \v{C}ech-trivializing, so using \Cref{cohomologically-trivial-fibers} and \Cref{cohomology-copropduct-direct-sum} we have
  \begin{align*}
