...
Note that the second axiom is the same: any f.p. $R$-algebra is quasi-coherent. The first axiom does not require
...
the proposition $D(n,\vec{r}) = D(r_1)\vee\dots\vee D(r_n)$.%For $n=0$, we get the proposition $1=_R 0$.
  ...
  $D(n,\vec{r})$, i.e. such that all diagonal maps $T\rightarrow T^{D(n,\vec{r})}$ are equivalences.
    ...
    \begin{proof}
      ...
      an element in $Um_n(R)$ exactly when $1=_R0$, and this implies that $(1=_R0)\rightarrow T$ is contractible.
    \end{proof}
