...
\[f:\I\to X\to L_\I(X)\]
such that $f(0) = [*]$ and $f(1)=[x]$. Since $L_\I(X)$ is $\I$-local this means that:
\[\prod_{x:X}[*]=[x]\]
We conclude:
\[\prod_{x:L_\I(X)}[*]=x\]
...
\begin{proof}
  ...
  By \Cref{ivt} and invertibility of one of the coordinates of $d_x$, there are intersections of $H_x$ and $\partial\mathbb{D}^2=\mathbb{S}^1$, both for $t\leq 0$ and for $t> 0$.
