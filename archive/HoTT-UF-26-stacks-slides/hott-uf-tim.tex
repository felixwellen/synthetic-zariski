...
Tim gave a an extension to $n$-types, based on [Simpson 96].
...
\bloc{Definition}{
An \'etale cover is a map whose fiber are formally \'etale and non-empty.
}
...
\bloc{Intuition}{
\begin{itemize}
\item \'Etale sheaf ``see'' affine \'etale covers as surjections.
\item If we have a formally \'etale goal, we can assume e.g.\ that separable polynomials have roots. 
\end{itemize}
}
