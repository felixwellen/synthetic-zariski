...
\hline
Synthetic algebraic geometry\footnote{[Blechschmidt 17], [Cherubini, Coquand, Hutzler 24], etc.} & Schemes \\
\hline
 {\renewcommand{\arraystretch}{1}
\begin{tabular}{c} 
	Condensed type theory\footnote{[Barton, Commelin 24]}/ \\ 
	Synthetic Stone duality\footnote{[Cherubini, Coquand, Geerligs, Moeneclaey 24]} \\
\end{tabular}} & 
{\renewcommand{\arraystretch}{1}
\begin{tabular}{c} 
...
%Synthetic Stone duality\footnote{[Cherubini, Coquand, Geerligs, Moeneclaey 24]} & compact Hausdorff spaces...\\
\hline
\end{tabular}
\end{center}
...
\item \vspace{0cm} [Blechschmidt 17] for internal duality in $1$-topoi.
