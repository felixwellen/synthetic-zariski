...
In classical algebraic geometry, the tangent sheaf is defined as the dual of the cotangent sheaf which is given affine locally by the universal module of derivations. We could copy this approach synthetically, but contrary to the classical picture, we can also define the tangent bundle and dualize to get the usual cotangent bundle. This mismatch with the classical theory comes from the fact that classical dualiuzation of $\mathcal O_X$-module sheaves is not the same as the dualization of $R$-module bundles we use.
