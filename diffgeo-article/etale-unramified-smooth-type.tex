...
\begin{definition}
  An étale (resp. smooth, unramified)\index{étale}\index{unramified}\index{smooth} scheme is a scheme which is formally étale (resp.\ formally smooth, formally unramified) as a type.
