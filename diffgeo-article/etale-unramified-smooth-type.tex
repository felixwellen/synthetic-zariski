...
\begin{remark}
  Let $f:X\to Y$ be a map. Then $f$ is formally étale/smooth/unramified if and only if there is exactly one/at least one/at most one lift in all squares
  \begin{center}
    \begin{tikzcd}
...
\rednote{TODO: prove or make statement for smooth maps local}
