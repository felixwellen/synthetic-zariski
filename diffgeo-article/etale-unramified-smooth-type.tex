...
\subsection{Algebraic examples and counter-examples}

\rednote{UNCLEAR WHAT THIS REFERS TO: Can be deduced from stability R smooth + smooth closed are decidable... Should we give the fun proof anyway?}

Since our definition of scheme already contains locally finite presentedness, the following definition matches the classical terminology.
...
\end{definition}
\rednote{should the following be example instead of lemma?}
