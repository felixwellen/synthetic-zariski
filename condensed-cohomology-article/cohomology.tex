...
The goal of this section is to extend \Cref{vanishing-first-stone} to higher cohomology groups. We proceed by induction on the cohomology index, which requires to strengthen the result to proving that taking the delooping of an overtly discrete abelian groups commutes with Stone-indexed $\Pi$-types.
