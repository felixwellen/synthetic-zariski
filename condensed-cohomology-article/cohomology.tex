...
\begin{proof}
 ...
 Note that the above sequence is $Hom_{Ab}(-,G)$ applied to the ordered chain complex (Definition 2.3) corresponding to $\mathbb I_n^\sim$. 
  ...
  $D_k$ a quotient of the free abelian\footnote{Note that in the reference definition 2.1, the word "abelian" is omitted, but otherwise the proof in 2.2 wouldn't make sense.} group on $\mathbb I_n^{\sim k}$ by the degenerate simplices. 
