...
\begin{proof}
  Exactness at $k=2$ is above. For $k\geq2$, by \Cref{LemmaInverseCsAtMostSize2}, $d_k$ is surjective, from which exactness follows. \rednote{TODO read with fresh eyes}
