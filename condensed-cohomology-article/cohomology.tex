...
\end{definition}
Using \parencite[Def VI.6.5,VI.6.6]{EilenbergSteenRod}, one can see that the alternating chain complex defined above agrees with the one defined in \parencite[Def VI.6.8]{EilenbergSteenrod},  
