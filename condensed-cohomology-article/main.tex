...
\appendix
\section{Non-abelian \v{C}ech cohomology}
\input{non-abelian-cech.tex}
\section{Abelian higher \v{C}ech cohomology}
\input{abelian-cech.tex}
\section{Combinatorial intervals}
\input{combinatorial-interval.tex}
\printbibliography
