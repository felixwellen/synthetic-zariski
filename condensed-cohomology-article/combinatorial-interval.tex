...
\begin{proof}
  ...
  By \parencite[Theorem VI.6.10]{EilenbergSteenrod}, this ordered chain complex is homotopy equivalent to the alternating chain complex $D_k$. Then $\mathrm{Hom}_{\mathrm{Ab}}(D_k,G)$ is trivial $k\geq 2$ as $D_k$ was trivial for by \Cref{RmkTrivialDk}.
