...
Most commonly used schemes are \emph{of finite type} and in this case,
...
a version quantifying over external algbras is called the \emph{comprehensive axiom}\footnote{
