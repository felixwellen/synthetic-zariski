We follow the notations and setting for Synthetic Algebraic Geometry \cite{SAG}.
In particular, $R$ denotes the generic
local ring and $GL_1$ is the multiplicative group of unit of $R$.

In Synthetic Algebraic Geometry, a scheme is defined as a set satisfying some property \cite{SAG}. In particular
...
$a_ib_j=a_jb_i$, which is equal to $\Sigma_{r:GL_1}ar = b$. We can then prove \cite{SAG}
...
We will use the following remark, proved in \cite{SAG}.
