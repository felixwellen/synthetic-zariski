...
is given on the type of submodules of $R^{n+1}$ merely equal to $R^1$, by forgetting the inclusion into $R^{n+1}$.
...
\begin{remark}
  ...
  \begin{center}
    \begin{tikzcd}
        (l:\KR)\times (T_n(l))\ar[rr]\ar[dr,swap,"\OO(1)"] && R^{n+1}\setminus\{0\}/R^\times\ar[ld,"\OO(1)"] \\
                  & \KR &
    \end{tikzcd}
  \end{center}
