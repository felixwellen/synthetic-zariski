...
are just sets with a particular property \cite{draft}[def of scheme],
...
From the point of view of \emph{synthetic homotopy theory}, this is not very interesting,
but it is fundamental to our intended applications in \emph{synthetic algebraic geometry}.
...
The first approach is more conceptual, more general and makes use of the higher types with have available in HoTT.
