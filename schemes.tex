...
\begin{proof}
  ...
  We will now assume, that both,
  $X$ and the $Y_x$ are general schemes.
  ...
  $V_{i,x,j}$ is only defined, if $U_i(x)$.
  So the proposition we are after, is equivalent to $(z:U_i(x,y))\times V_{i,z,j}(y)$.
