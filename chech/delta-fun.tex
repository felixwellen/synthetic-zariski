...
\rednote{TODO: The proof needs to be updated to the current notion of 'has local resolutions' - not problems expected.}
\begin{proof}[of \cref{thm:universal}]
  ...
  \begin{center}
    \begin{tikzcd}
      A\ar[r]\ar[d,"\varphi"] & M_\chi\ar[r]\ar[d] & C_\chi\ar[d] \\
      B\ar[r] & M_{\varphi,\mathcal{S}'}\ar[r] & C_{\varphi,\mathcal{S}'} \\
      B\ar[r,"m_{\varphi(\chi)}"]\ar[u,equal] & M_{\varphi(\chi)}\ar[r]\ar[u] & C_{\varphi(\chi)}\ar[u]
    \end{tikzcd}
  \end{center}
