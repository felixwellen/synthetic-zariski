...
\begin{definition}
  A \notion{$\partial$-Functor} is a collection of functors $T^i:\mathcal A\to \AbGroup$, where $0\leq i < a$ with $a\in\N\cup\{\infty\}$,
...
\begin{lemma}
  ...
  and any morphism of $(i-1)$-truncated $\partial$-functors $f:T\to T'$, there is a unique\index{$\mathrm{ext}(\chi,S)$}
