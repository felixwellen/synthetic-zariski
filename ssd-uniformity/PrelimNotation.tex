\begin{definition}
  ...
  We call a relation \textbf{open} or \textbf{closed} if it takes value in open or closed propositions respectively. 
  A relation is called \textbf{reflexive} whenever it contains the diagonal $\Delta$ as a subset.
