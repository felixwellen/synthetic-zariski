...
- A systemd  timer (```/etc/systemd/user/sag-latex.timer```) 
  ...
  folders=("A1-homotopy" "cech" "condensed" "condensed-sheaves" "diffgeo" "elliptic" "exercises" "finite" "foundations" "proper" "random-facts" "sheaves" "stacks" "topology" "projective")
