...
\end{lemma}
\begin{proof}
  Assume WLOG that $I = \mathbb N_{\leq n}$ and define $U_{n+1} = \emptyset$.
  We will recursively define for each $i:\mathbb N_{\leq n}$ 
  a sequence $V_i \subseteq D_i \subseteq U_i$
  with $D_i$ closed and $V_i$ open, 
  such that for all $l:\mathbb N_{\leq n+1}$ we have 
...
\end{proof}
\rednote{TODO decide which is nicer}
\begin{proof}
...
\begin{proof}
  ...
  By lemma \Cref{ReducesToDelta} it is sufficient 
\end{proof}
