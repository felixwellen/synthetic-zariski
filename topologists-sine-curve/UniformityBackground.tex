...
\end{lemma}
\begin{proof}
  Assume WLOG that $I = \mathbb N_{\leq n}$. We will define for each $l:\mathbb N_{\leq n+1}$ and each $0\leq i < l$ a sequence $V_i \subseteq D_i \subseteq U_i$ with $D_i$ closed and $V_i$ open, and such that
