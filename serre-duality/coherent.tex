...
\begin{proof}
  ...
  \begin{center}
    \begin{tikzcd}
      A\ar[r] & B\ar[r,->>] & K\ar[r,hook] & M\ar[r] & N
    \end{tikzcd}
  \end{center}
  where $B$ is finitely co-presented, $M,N$ are finitely presented and $K\to M$ is a kernel, $B\to K$ a cokernel.
  Taking double duals and using \Cref{fp-kernel-dual-surjective} we end up in this situation:
  \begin{center}
    \begin{tikzcd}
      A\ar[r] & B\ar[r,->>]\ar[d,"\sim"] & K\ar[r,hook]\ar[d,hook] & M\ar[d,"\sim"]\ar[r] & N \\
              & B^{\ast\ast} \ar[r,->>] & K^{\ast\ast} \ar[r] & M^{\ast\ast} &
    \end{tikzcd}
  \end{center}
