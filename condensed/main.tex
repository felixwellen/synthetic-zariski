...
%  Suppose that $f(x) = 0$. We will show that $x = 0$. 
...
%
%      But now as $p_i\neq 0$ for all $i\in\mathbb N$, we must have $I_0 \cap E = \emptyset = I_0 \cap O$. 
%      Thus $I_0= \emptyset$, and $x = 0$. 
%    \item Let $x$ correspond to a cofinite subset of $\mathbb N$. Write 
%      $x = \bigwedge_{j\in J} \neg p_j$ for $J$ cofinite. 
%      We will derive a contradiction, showing that $x=0$ after all. 
...
%      Thus both $J\cap E$ and $J\cap O$ must be $\mathbb N$. 
%  \end{itemize}
