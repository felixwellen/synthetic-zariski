...
%      Let $\alpha,\beta:2^\mathbb N$ be such that 
%      $P\leftrightarrow \forall_{n:\mathbb N} \alpha(n) = 0$ and 
%      $Q\leftrightarrow \forall_{n:\mathbb N} \beta(n) = 0$. 
%      Let $\gamma:2^\mathbb N$ be such that $\gamma(n) = 0$ iff 
