...
\begin{lemma}\label{lemOpenClosedDisjunctionConjunction}
  Open propositions are closed under countable disjunctions and finite conjunctions. 
  Closed propositions are closed under countable conjunctions and finite disjunctions. 
\end{lemma}
\begin{proof}
  \begin{itemize}
    ...
    \item Let $P_n$ be a countable family of closed propositions. We will show that 
      $\forall_{n:\mathbb N} P_n$ is countable as well. 
      \rednote{Active here}
  \end{itemize}
