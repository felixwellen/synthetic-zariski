...
\rednote{Discussion on what the colimit is exactly}
...
\end{definition} 
\begin{remark}
  Such a sequential colimit is a set \cite{ SequentialColimitHoTT}?
%  For $\mathcal U$ an universe, we denote $\ODisc_\mathcal U$ 
%  for the overtly discrete types in $\mathcal U$.
