...
\begin{proof}
  ...
  take $f_n' = e_n$.
\end{proof}
\subsection{Closure properties of overtly discrete types}
\begin{lemma}
...
\begin{proof}
  ...
  We then have that for every $i:\N$, $\Sigma_{b:B_i} (X\circ \iota_i(b))$ is a finite coproduct of of overtly discrete 
  types, and as colimits commute with finite products, this is overtly discrete. 
  By Theorem 5.1 of \cite{SequentialColimitHoTT}, 
  taking the colimit over the latter sequence, we get $\Sigma_{b:B} X(b)$. 
