...
\begin{remark}
  ...
  overtly discrete types are sets, and the colimit can be defined as in set theory. 
  Note that the type of overtly discrete types is independent on choice of universe, 
  so we can write $\ODisc$ for this type. 
\end{remark}
  We can follow the usual proof for the following results: 
  ...
  \begin{lemma}\label{lemDecompositionOfColimitMorphisms}
      A map of overtly discrete sets is a sequential colimit of maps between finite sets. 
  \end{lemma}
  \begin{proof}
  ...
  \begin{lemma}\label{lemDecompositionOfEpiMonoFactorization}
    ...
    $f:A\to B$ a sequential colimit of maps of finite sets $f_n:A_n \to B_n$, we have 
      ...
      sequential colimit of factorisations 
