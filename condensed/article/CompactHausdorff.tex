...
The next lemma means that compact Hausdorff space are not too far from being compact in the classical sense.
...
The next lemma means that compact Hausdorff space are normal.
