...
Let $S:\Stone$ and $T:S\to\Stone$ such that $\prod_{x:S}\propTrunc{T(x)}$.
There exists a sequence of finite types $(S_k)_{k:\N}$ with limit $S$, 
...
%such that: 
%\[\mathrm{lim}_kS_k = S\]
a compatible sequence of families of finite types $T_k$ over $S_k$
