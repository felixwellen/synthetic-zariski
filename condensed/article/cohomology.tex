...
\end{lemma}
\rednote{Is the lemma stated correctly? It seems the last step of the proof needs $\prod_{x:S}\|T_x\|$.}
...
\begin{proof}
By \cref{eilenberg-stone-vanish} \rednote{is the reference correct?} we have an exact sequence of complexes:
