...
%     by \Cref{OdiscQuotientCountableByOpen}
     there is a countable set $I$ with a surjection $d:I\to Ker(g)$. For $i:I$, wenote by $D_i$ the decidable subset of $S$ corresponding to $d_i$. Then we have that $\Sp(B/Ker(g)) = \bigcap_{i:I} D_i$. 
