...
Here we consider the modality defined by localising at $\mathbb{I}$ \cite{paper on modality in HoTT}, denoted by $L_\mathbb{I}$. We say $X$ is $\mathbb{I}$-local if $L_\mathbb{I}(X) = X$ and that it is $\mathbb{I}$-contractible if $L_\mathbb{I}(X)=1$.

In this section we define $\mathbb{S}^1$ as $\R/\Z$ (TODO reference for why this is good).
...
We have that $\R$ and $\mathbb{D}^1$ are $\mathbb{I}$-contractible.
\end{corollary}

\begin{proposition}\label{shape-S1-is-BZ}
We have that $L_\mathbb{I}(\mathbb{S}^1) = B\Z$.
\end{proposition}
...
\begin{remark}
By \cref{BZ-I-local}, for any $X$ we have that $H^1(X,\Z) = H^1(L_\mathbb{X},\Z)$, so that by \cref{shape-S1-is-BZ} we have that $H^1(\mathbb{S}^1,\Z) = H^1(B\Z,\Z) = \Z$.
\end{remark}

\begin{proposition}
The map $\mathbb{S}^1\to \mathbb{D}^1$ has no retraction.
\end{proposition}
