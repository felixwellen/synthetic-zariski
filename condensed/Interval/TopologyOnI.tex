...
\item 
  ...
  As this is a disjunction of closed propositions, by \Cref{ClosedDisjunction} it's closed, and by 
  ...
  but then by \Cref{SqueezeLemma}, we must have $x|_k = (a\cdot \overline 1)|_k$. 
