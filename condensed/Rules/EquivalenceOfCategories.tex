...
%  $1 = 1 - 0 \leq \bigvee_{r\in R_0} r$ for some $R_0\subseteq R$ finite. 
%  As $1$ is maximal, this implies that $1 = \bigvee_{r \in R_0} r$.
...
%
%  Now if $r\in R_0$, then $r = f(b)$ for some $b\in A$ with $x(b) = 0$. 
%  Choosing for each $r$ some $b$ with this property, we get some finite set $B_0 \subseteq A$ with 
%  $1=\bigvee_{r\in R_0} r = f(\bigvee_{ b \in B_0 } b)  $. 
%  By injectivity of $f$, it follows that $\bigvee_{ b \in B_0 } b = 1$. 
%  However, as $x(b)=0$ for all $b\in B_0$, we have that $x(\bigvee_{b \in B_0} b) = 0$, 
%  meaning $1 = x(1) = 0$, which gives a contradiction as $0\neq_2 1$.
