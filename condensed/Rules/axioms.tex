...
\begin{axiomNum}[Stone duality]\label{AxStoneDuality}
...
\begin{axiomNum}[Surjections are formal surjections]\label{SurjectionsAreFormalSurjections}
...
%\end{axiomNum} 
%\begin{axiomNum}[Local choice]\label{AxLocalChoice}
