...
\end{lemma} 
\begin{proof}
  By \Cref{CHausSeperationOfClosedByOpens}, there exist disjoint $U,V:X\to \Open$ with 
  $A\subseteq U, B\subseteq V$. 
  Hence  $Q_x \subseteq U\cup V$ and by \Cref{ConnectedComponentSubOpenHasDecidableInbetween}, 
