...
\rednote{WIP: I noticed during writing that this has still a big gap...}
Related, but not generalized to an instance of the same thing yet:

\begin{proposition}
  Let $X$ be an irreducible, étale-overt, pointed scheme.
  If $G_x$ is a group for all $x:X$ which is an étale sheaf with decidable equality, then:
  \[
    H^1(X,G)=0.
  \]
\end{proposition}
