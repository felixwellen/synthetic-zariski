...
\begin{lemma}
  Let $X$ be an étale-overt irreducible type whose identity types are étale-sheaves, $Y$ a connected type such that $\|Y\|_\et$ and $f:X\to Y$ unramified separated
  \footnote{i.e. all fibers are unramified separated schemes -- we could just say map with decidable fibers here as well}.
