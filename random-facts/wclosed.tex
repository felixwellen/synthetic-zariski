...
Below, (c)) comes from the definitions in \cite{lesnik2021synthetictopologyconstructivemetric}[p. 47], where we choose ``T'' and ``\(\Sigma\)'' to be the type of propositions and compute that ``\(Z\)'' is the type of weakly closed propositions using \cite{lesnik2021synthetictopologyconstructivemetric}[Theorem 2.53].
