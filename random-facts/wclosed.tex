...
Below, \ref{lesnik-characterization} comes from the definitions in \cite{lesnik2021synthetictopologyconstructivemetric}[p. 47], where we choose ``T'' and ``\(\Sigma\)'' to be the type of open propositions and compute that ``\(Z\)'' is the type of weakly closed propositions using \cite{lesnik2021synthetictopologyconstructivemetric}[Theorem 2.53].

\begin{remark}
  \begin{enumerate}[(a)]
  \item Let \(U\) be an open proposition, then \(\neg U\) is weakly closed.
  \item Propositions that are weakly closed and open are decidable.
  \item \label{lesnik-characterization} A proposition \(P\) is weakly closed if and only if \(P\to U\) is open for all open propositions \(U\).
  ...
  \item Question: Let \(C\) be closed and \(W\) weakly closed such that \(\neg\neg C=\neg\neg W\).
    Is \(C\wedge W\) closed?
  \item Compact propositions are weakly closed. Question: Are weakly closed propositions compact?
  \end{enumerate}
\end{remark}
...
\begin{proof}
  \begin{enumerate}[(a)]
  \item \(\neg\neg U=U\)
  \item If \(P\) is weakly closed and open, we have \(\neg\neg(P\vee\neg P)=P\vee\neg P\).
  ...
  \item ?
  \item Compact propositions are weakly closed because of \ref{lesnik-characterization}. Let \(C\) be weakly closed and \(U\subseteq C\) be open.
    \begin{align*}
      (x:C)\to U(x) = (x:C)\to \neg\neg U(x) = \neg \Sigma_{x:C}\neg U(x)
    \end{align*}
  \end{enumerate}
