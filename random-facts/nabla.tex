...
From a conversation with Andrej Bauer:

\begin{lemma}
  Any \(\nabla\)-modal type is formally étale.
\end{lemma}

\begin{proof}
  Let \(\epsilon:R\) with \(\epsilon^2=0\) and \(\phi:\epsilon=0\to X\) with \(X\) \(\nabla\)-modal.
  We have \(\phi^\prime:\epsilon=0\vee\epsilon\neq 0\to X\) which coincides with \(\phi\),
  since \(\neg\neg\epsilon=0\).
  Since \(X\) is \(\nabla\)-modal, we have an extension of \(\phi^\prime\) and \(\phi\).
\end{proof}
...
\begin{proof}
  This is in \cite{diffgeo-article} for formally étale/formally unramified closed propositions.
\end{proof}
