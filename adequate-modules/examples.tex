...
\begin{example}\label{ex:fin-gen-ideal}
  ...
  Then $I$ is finitely adequate. Indeed it is the kernel of the map $R\to R/I$ with $R$ and $R/I$ finitely presented.
...
\begin{counterexample}\label{cex:K^Dr-not-fin-adeq}
  ...
  Now, by \Cref{prp:ann-fin-adeq} and \Cref{cex:K-not-Dr-not-wqc} we know that $K^{D(r)}$ cannot be finitely adequate for all $r : R$.
\end{counterexample}
