...
\begin{proof}
  ...
  \begin{eqnarray}
  x\in \Ann(R_U) &=& \forall y:R,\, (U\lor x=0) \to xy=0 \nonumber\\
  & = & \forall y:R,\, U\to xy=0 \nonumber\\
  & = & U\to \forall y:R,\, yx=0 \nonumber\\
    & = & U\to x=0 \nonumber\\
    & = & x\in K^U\nonumber
...
We have that
  \begin{eqnarray}
  (R/I)^\ast & = & \setbuild{x:R^\ast}{\forall y:I,\, x(y) = 0} \nonumber\\
& = & \setbuild{x:R}{\forall y:I,\, xy = 0} \nonumber\\
   &= & \Ann(I) \nonumber
  \end{eqnarray}
...
Since both $R[X]$ and $R[[X]]$ are not finitely adequate, we have reflexive $R$-module that are not finitely adequate.
