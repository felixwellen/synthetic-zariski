...
\begin{example}\label{ex:power-series-tangential}
  ...
  Note that $R[[x]]$ is not adequate, as it is not weakly quasi-coherent (see \cite{draft}[Proposition A.0.5]).
\end{example}
...
\begin{counterexample}\label{cex:polynomial-power-series-not-fin-adeq}
  ...
  \rednote{Hugo, why the switch to capital variables?  The rest of the paper uses lower case.}
