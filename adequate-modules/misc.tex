...
\item What are examples of modules that are not finitely adequate?
      ...
      % We give a constructivized, but adapted, version of the proof given in \cite[Proposition 3.2]{conner2021inverselimitslendergroups} (I have not yet added this reference), which seems to be folklore.
      % The proof in loc.cit.\ works over $\mathbb Z$ and makes use of the prime factorization, which we replace by a neat degree-counting argument using duality.
