...
\author{Felix Cherubini \and J. Daniel Christensen \and Fabian Endres \and Hugo Moeneclaey \and Thomas Thorbjørnsen}
\date{\today}
...
\newcommand{\mc}[1]{\mathcal{#1}} % Shorthand for calligraphic font
...
% By default, \Mod{R} displays as R-Mod, but let's make it consistent with the above:
\def\Mod{\modcat}
...
% --- Special Operators --- %
\newcommand{\dbldualtensor}{\mathbin{\smash[t]{\overset{\scriptscriptstyle\ast\ast}{\otimes}}}}
...
\input{brief-intro.tex}
\paragraph{Contributions and organization.}
\input{contributions.tex}
\paragraph{Acknowledgements.}
\input{acknowledgements.tex}
\subsection{Foundation and Conventions}\label{ss:foundation}
\input{background-and-conventions.tex}

\section{Infinitesimally Linear Types}
\label{infinitesimally-linear-section}
\input{infinitesimally-linear.tex}

\section{Finitely Adequate Modules}
\label{adequate-section}
\input{adequate.tex}
