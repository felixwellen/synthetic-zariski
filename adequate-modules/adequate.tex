...
\begin{remark}
  ...
  To see this, consider the maps $\alpha_\varepsilon : R\varepsilon \to R\varepsilon, r\varepsilon \mapsto r^2\varepsilon$ for every $\varepsilon:\D(1)$.
  These are well-defined, since $r\varepsilon = s\varepsilon$ implies $r^2\varepsilon-s^2\varepsilon = (r+s)(r-s)\varepsilon = 0$.
  Since for every $n:R\varepsilon$ we have $(\varepsilon=0)\to(n=0)$, we conclude that $R\varepsilon = \hood{R\varepsilon,0}{1}$.
