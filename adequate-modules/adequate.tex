...
\begin{lemma}\label{lem:hood-module-prs-surj}
  Let $f : M \rightarrow N$ be an epimorphism of $R$-modules with $M$ linearly adequate
...
\begin{proof}
  ...
  Consider the map $\pi_\varepsilon : R \to \varepsilon R$ which multiplies by $\varepsilon$.
  Note that $R$ is linearly adequate and $\varepsilon R$ is finitely adequate
  ...
  Note that $\pi_\varepsilon(1) = \varepsilon \in \hood{\varepsilon R,0}{1}$ since $(\varepsilon)=0 \to \varepsilon=0$.
  Let $r:\D(1) = \hood{R,0}{1}$ be a lift of $\varepsilon$. Then $\pi_\varepsilon(r-1)=0$, i.e., $\varepsilon(r-1)=0$.
