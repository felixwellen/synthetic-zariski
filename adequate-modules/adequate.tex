...
\begin{proof}
  ...
  \begin{description}[leftmargin=3.5em, labelwidth=3em, labelsep=0.5em, align=left]
    \item[$1.\Rightarrow 2.$] Applying the naturality of $\varepsilon$ to $F\eta_X$ and using the triangle identity, we obtain the following commutative diagrams:
    \begin{center}
      \begin{tikzcd}
...
This functor is right adjoint to itself (i.e., self-adjoint), meaning that $\Hom_R(A, B^\ast) \simeq \Hom_R(B,A^\ast)$.
