...
\begin{proof}
  ...
  The third map is the equivalence coming from currying \rednote{I do not see why this should work, there seems to be a mixup between linear maps and maps of types. If there is more to it, it needs more explanation}, since $R^{\Spec A}$ carries the pointwise module structure.
