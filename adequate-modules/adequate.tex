...
\begin{proof}
  ...
  To construct $c$, let $c_0 \coloneq L_2 \circ l$.
  Note that $c_0$ vanishes on $A$ and therefore extends to a linear map $c_1 : \mathrm{im}(t) \to R$ on the image of $t$.
  ...
  so $L_2 - c$ is still an extension of $L_1$ that vanishes on $A$.
\end{proof}
