...
\begin{proof}
  ...
  We get an induced exact sequence $0 \to H(A) \to H(B) \to H(C) \to \Ext^1(M^\ast,A)$, where $\Ext^1$ is the first right derived functor of $H$ defined in terms of injective resolutions.
  We finish the proof by observing that $\Ext^1(M^\ast,A)=0$ by virtue of \Cref{identification-hom-tensor-for-fp-modules}.
  % ---- OLD PROOF ----
