...
\begin{proof}
  ...
  The second map is an equivalence due to reflexivity and the last to duality.
...
By the universality of kernels we then see that $(1)$ is an equivalence as well.
\end{proof}
