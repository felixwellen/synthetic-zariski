...
\begin{proof}
  ...
  The rest follows from \Cref{prp:tangential-qc}, \Cref{prp:inf-lin-qc}, and \Cref{prp:wqc-adeq}.
\end{proof}
...
\begin{proof}
  ...
  Observe that $E$ is tangent-like by \Cref{prp:op-closure-inf-lin-tangential}, since $B$ and $L$ are tangent like by \Cref{cor:tangent-like-qc}.
