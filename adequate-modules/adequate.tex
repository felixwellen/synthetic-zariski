...
\begin{proof}
We check directly that we have a pullback square:
  \begin{center}
    \begin{tikzcd}
   \Ker(u) \ar{r}\ar{d}& A\ar{d}{(u,f)}\\
   \Ker(v) \ar{r}& B\oplus C
    \end{tikzcd}
  \end{center}
Then both vertical arrows have the same kernel by pullback pasting.
\end{proof}
