...
In \Cref{cex:tensor-not-closed} we will see, that the tensor product $M \otimes N$ is not necessarily finitely adequate even when $M$ and $N$ are linearly adequate.
