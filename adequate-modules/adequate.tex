...
\begin{remark}
  The equivalence of \Cref{identification-hom-tensor-for-fp-modules} does not generalize to all finitely adequate $R$-modules $N$, even if we specialize to a finitely presented $M$.
