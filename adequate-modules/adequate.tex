...
\rednote{This could maybe move to the appendix.  Not sure if we need it in the final paper.}
...
\newcommand{\Ne}{22}
\rednote{Dan doesn't follow the argument in the next remark.  What are the objects in the domain category, and what map between their images under $\hood{-,0}{1}$ fails to have a preimage?  (Also, what is the \textbackslash Ne macro for?)  Also, it might be easier to read using the image of $\varepsilon$ instead of the quotient of the kernel.}
\begin{remark}
