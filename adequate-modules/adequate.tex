...
\begin{proof}
  ...
  Equivalently, this means that $M^\ast$ is projective, i.e.\ we need to show that $H :\equiv \Hom_R(M^\ast,-)$ is exact on the category of finitely adequate modules.
  ...
  Thus by virtue of \Cref{identification-hom-tensor-for-fp-modules} we have $\Ext_R^1(M^\ast,A)=0$.
\end{proof}
