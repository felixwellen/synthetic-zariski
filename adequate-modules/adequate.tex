...
\begin{definition}\label{def:rel-epi}
  Let $\mathfrak{C}$ be a class of objects in $\mathcal{C}$. A map $f : X \to Y$ is \textbf{$\mathfrak{C}$-epic} if for any $Z$ in $\mathfrak{C}$ and any morphisms $g, h : Y \to Z$ such that $g \circ f = h \circ f$, we have $g = h$.
\end{definition}
...
\begin{proof}
  (i) $\Rightarrow$ (iii): Assume that $MX$ is $M$-reflexive, i.e. $\eta_{MX}$ is an isomorphism.
  Then $M\eta_X$ is an isomorphism as well, since both $M\eta_X$ and $\eta_{MX}$ are sections of $\mu_X$.
  ...
  Thus $Mf = Mg$ since $M\eta_X$ is a monomorphism.
  ...
  (iii) $\Rightarrow$ (ii): By \cref{lem:monad-app-torsionless}, $MX$ is $M$-torsionless.
  By naturality of $\eta$, we have $\eta_{MX} \circ \eta_X = M\eta_X \circ \eta_X$. 
  Thus $M\eta_X = \eta_{MX}$, since $\eta_X$ is $M$-torsionless-epic.
  
  (ii) $\Rightarrow$ (i): By unitality we already know that $\mu_X \circ M\eta_X = \id_{MX}$.
  By unitality, and using $M\eta_X = \eta_{MX}$, we get $$\id_{M^2X} = \mu_{MX} \circ M\eta_{MX} = \mu_{MX} \circ M^2\eta_{X}$$
...
\begin{proposition}\label{prp:monad-factorization}
  Let $f : X \to Y$ be a morphism in $\mathcal{C}$. Then $f$ factors uniquely through $\eta_X$ if $MX$ is $M$-reflexive and $Y$ is $M$-reflexive.
\end{proposition}
